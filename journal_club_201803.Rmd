...
*  find low dimensional representation of cancer gene expression data, dicovery of clinically relevant tumour subtypes  
...
* CT image segmentation (e.g. select liver area in CT images)  
